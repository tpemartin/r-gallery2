...
export function GalleryCard({project, number, group, ratingControl}) {
  ...
  return (
    ...
    <Paper elevation={3} sx={{p: 3}}> 
      <Stack direction="column" spacing={2}>
        ...
        <GalleryCardAction github_link={project["Github link"]} group={group} ratingControl={ratingControl} />
      </Stack>
    </Paper>
    </>
  )
...
export default function GalleryGridCard({project, number, group, ratingControl}){


  return <>
  <Grid xs={12} sm = {6} md={4} xl={3}>
    <GalleryCard project={project} number={number} group={group} ratingControl={ratingControl}/>
  </Grid>
  </>
